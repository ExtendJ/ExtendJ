...
/*public interface testInterface {
	...
	public default strictfp int idValue(){
		return 7;
	}
	
	default public int hValue() {
		return 0;
	}
	
	public private default abstract strictfp int iiValue() {
		return 5;
	}
...
public class Test {
	...
	public static void main(String[] args) {
		...
		Object g;
		f = (ArrayList<Integer> & Runnable<Double> & Comparable)g;
		f = new Integer(1)::toString;
		f = "abc"::length;
		f = "abcd"::<Integer, String>length;
		f = super::f;
		f = i.g.h.super::i;
		f = Callable::run;
		f = ArrayList<Integer, Double>::new;
		ret(Callable<Integer, ArrayList<Int, String>>::call);
		...
		f = ArrayList<String>::new;    // constructor for parameterized type
		f = ArrayList::new;            // inferred class type args, or generic
		f = Foo::<Integer>new;         // explicit generic constructor type arguments
		f = Bar<String>::<Integer>new; // generic class, generic constructor
