...
public class Parser implements Flags {
  ...
  private static class DummyInputStream extends InputStream {
	...
	public CompilationUnit parse(TypeDecl outerTypeDecl, CONSTANT_Class_Info outerClassInfo, AST.Program classPath, boolean isInner) 
    ...
    cu.addTypeDecl(typeDecl);
		...
		new TypeAttributes(this, typeDecl, outerTypeDecl, classPath);
