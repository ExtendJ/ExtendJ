...
public class Test {
	...
	interface B {
		List<String> foo(List<String> arg) throws EOFException, FooException, TimeoutException;
	}
	interface C {
	...
	public static List<String> someMethod() throws FooSubException {
		return null;
	}
	
	public static void main(String[] args) {
		E e = a -> someMethod();
		//E e = a -> { throw new FooSubException(); };
	}
}
