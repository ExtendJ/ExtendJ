 ...
 */
class JavaDumpStructuredPrint extends Frontend {
	...
	public static void main(String args[]) {
		int exitCode = new JavaDumpStructuredPrint().run(args);
		if (exitCode != 0) {
	 ...
	 */
	public JavaDumpStructuredPrint() {
	...
	public static boolean compile(String args[]) {
		return 0 == new JavaDumpStructuredPrint().run(args);
	}
