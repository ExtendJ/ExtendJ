# Broken bytecode when using generic type in for-statement condition
...
```java
// Test for-statement with generic condition.
// .result: EXEC_PASS
public class Test {
...
```
    [junit] [FAIL] runTest[run/generics/container_03](tests.extendj.TestJava7)
